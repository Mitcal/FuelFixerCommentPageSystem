...
class CommentsController extends Controller
{
    ...
    public function index()
    {
        ...
        $comments = Comment::with(['page', 'author', 'parent'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.comments.create', compact('pages', 'authors', 'parents'));
    }
    ...
    public function edit(Comment $comment)
    {
        ...
        return view('frontend.comments.edit', compact('pages', 'authors', 'parents', 'comment'));
    }
