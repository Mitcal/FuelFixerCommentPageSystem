                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.comments.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="author_url" id="author_url" value="{{ old('author_url', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="author_ip" id="author_ip" value="{{ old('author_ip', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="date_gmt" id="date_gmt" value="{{ old('date_gmt') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="karma" id="karma" value="{{ old('karma', '') }}" step="1">
                            @if($errors->has('karma'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('karma') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="agent" id="agent" value="{{ old('agent', '') }}">
                            @if($errors->has('agent'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('agent') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="approved_date" id="approved_date" value="{{ old('approved_date') }}">
