    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.comments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('author_url') ? 'is-invalid' : '' }}" type="text" name="author_url" id="author_url" value="{{ old('author_url', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('author_ip') ? 'is-invalid' : '' }}" type="text" name="author_ip" id="author_ip" value="{{ old('author_ip', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_gmt') ? 'is-invalid' : '' }}" type="text" name="date_gmt" id="date_gmt" value="{{ old('date_gmt') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('karma') ? 'is-invalid' : '' }}" type="number" name="karma" id="karma" value="{{ old('karma', '') }}" step="1">
                @if($errors->has('karma'))
                    <div class="invalid-feedback">
                        {{ $errors->first('karma') }}
                    </div>
